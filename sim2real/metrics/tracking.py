...
METRIC_ROW_FIELDS = (
    ...
    "success",
    "completion_ratio",
    "global_root_pos_xyz_mean_m",
    "global_root_pos_xyz_p95_m",
    "global_root_pos_xy_mean_m",
    "global_root_pos_xy_p95_m",
    "global_root_ori_mean_rad",
    "global_root_ori_p95_rad",
    "global_key_body_pos_mean_m",
    "global_key_body_pos_p95_m",
    "global_key_body_ori_mean_rad",
    "global_key_body_ori_p95_rad",
    "global_end_effector_pos_mean_m",
    "global_end_effector_pos_p95_m",
    "global_end_effector_ori_mean_rad",
    "global_end_effector_ori_p95_rad",
    "global_key_body_vel_error_mean_mps",
    "global_key_body_vel_error_p95_mps",
    "global_key_body_acc_error_mean_mps2",
    "global_key_body_acc_error_p95_mps2",
    "local_key_body_pos_mean_m",
    "local_key_body_pos_p95_m",
    "local_key_body_ori_mean_rad",
    "local_key_body_ori_p95_rad",
    "local_end_effector_pos_mean_m",
    "local_end_effector_pos_p95_m",
    "local_end_effector_ori_mean_rad",
    "local_end_effector_ori_p95_rad",
    "joint_pos_mae_rad",
    "joint_pos_rmse_rad",
    "joint_pos_p95_abs_rad",
    "joint_vel_mae_rad_s",
    "joint_vel_rmse_rad_s",
    "joint_vel_p95_abs_rad_s",
    "joint_acc_rms_rad_s2",
    "joint_acc_p95_abs_rad_s2",
    "joint_jerk_rms_rad_s3",
    "joint_jerk_p95_abs_rad_s3",
    "progress",
    "global_root_tracking_error",
    "global_root_tracking_error_xy",
    "local_body_tracking_error",
    "mpjpe",
    "root_final_error_norm",
    "root_final_error_xy_norm",
)
